...
The easiest way to deploy your Next.js app is to use the [Vercel Platform](https://vercel.com/new?utm_medium=default-template&filter=n…m_source=create-next-app&utm_campaign=create-next-app-readme) from the creators of Next.js.
...
```bash
   git clone [https://github.com/minhkhangle721-cpu/VSTEP-Learning-Hub.gi…ttps://github.com/minhkhangle721-cpu/VSTEP-Learning-Hub.git)
